<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageSlides.aspx.cs" Inherits="LMS.ManageSlides" %>
...
<head>
    ...
    <title>Manage Slides &#8211; LMS a WordPress Theme</title>
...
/* ]]> */
    ...
    <link rel="canonical" href="https://www.library-management.com/manage-slides/" />
    <link rel='shortlink' href='https://www.library-management.com/?p=28' />
    <link rel="alternate" type="application/json+oembed" href="https://www.library-management.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.library-management.com%2Fmanage-slides%2F" />
    <link rel="alternate" type="text/xml+oembed" href="https://www.library-management.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.library-management.com%2Fmanage-slides%2F&#038;format=xml" />
                                            ...
                                            <tr ng-show="full_slides.length!=0" ng-repeat="slide in full_slides">
                                                ...
                                                <td class="slide_img_holder" style="width: 80%;">
                                                    <div class="brnd_img_holder">
                                                        <img src="{{slide.img_url}}" class="img-responsive">
                                                    </div>
                                                </td>
                                                <td style="width: 20%">
                                                    <button class="btn btn-warning" ng-click="editSlide(slide)">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </button>
                                                    <button class="btn btn-danger" ng-click="delSlide(slide)">
