<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportBugs.aspx.cs" Inherits="LMS.ReportBugs" %>
...
<head>
    ...
    <title>Report Bugs &#8211; LMS a WordPress Theme</title>
...
/* ]]> */
    ...
    <link rel="canonical" href="https://www.library-management.com/report-bugs/" />
    <link rel='shortlink' href='https://www.library-management.com/?p=30' />
    <link rel="alternate" type="application/json+oembed" href="https://www.library-management.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.library-management.com%2Freport-bugs%2F" />
    <link rel="alternate" type="text/xml+oembed" href="https://www.library-management.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.library-management.com%2Freport-bugs%2F&#038;format=xml" />
...
<body class="page-template page-template-report_bug page-template-report_bug-php page page-id-30 logged-in hold-transition skin-blue sidebar-mini">
                                                ...
                                                <form class="form-horizontal" id="frm_reportbug">
                                                    ...
                                                    <div class="form-group mb0 col-sm-12">
                                                        ...
                                                        <button ng-click="sendInfo()"
                                                            ...
                                                            <span class="fa fa-floppy-o"></span>&nbsp;Send Email
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
