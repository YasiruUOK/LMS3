<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageCourse.aspx.cs" Inherits="LMS.ManageCourse" %>
...
/* ]]> */
    ...
    <link rel="canonical" href="https://www.library-management.com/manage-course/" />
    <link rel='shortlink' href='https://www.library-management.com/?p=14' />
    <link rel="alternate" type="application/json+oembed" href="https://www.library-management.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.library-management.com%2Fmanage-course%2F" />
    <link rel="alternate" type="text/xml+oembed" href="https://www.library-management.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.library-management.com%2Fmanage-course%2F&#038;format=xml" />
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        $('#courseTable').append('<tr><td>' + data[i].CourseName + '</td><td></td></tr>');
                    }
...
<body class="page-template page-template-managecourses page-template-managecourses-php page page-id-14 logged-in hold-transition skin-blue sidebar-mini">
