<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBook.aspx.cs" Inherits="LMS.AddBook" %>
...
<script>
    ...
    function add_book_details() {
        ...
        if (book_qty != "" && book_price != "") {
            jQuery.ajax({
                type: "POST",
                url: "api/myapi/addBookDetails",
                data: JSON.stringify({
                    bookTitle: titleInput, isbnCode: isbnInput, author: authorInput, publisher: publisherInput, price: book_price, bookCategory: book_category, bookURL: book_url, bookImage: book_upload_img, bookPDF: book_upload_pdf, bookExternalURL: book_external_url, qty: book_qty, bookDescription: book_desc
                }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                                    ...
                                    <div class="panel panel-custom">
                                        ...
                                        <div class="panel-body form-horizontal">
                                            ...
                                            <div class="form-group md0 col-sm-12" style="padding-right: 0px;">
                                                <button type="button" onclick="add_book_details();" class="btn btn-primary fix_radius pmd-ripple-effect pull-right">
                                                    <span class="fa fa-floppy-o"></span>Add Book
                                                </button>
                                            </div>
                                        </div>
                                    </div>
